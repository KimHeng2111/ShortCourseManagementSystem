...
Public Class Form1
    ...
    Public Sub New(reg As Register)
        ...
        'Dim invoic As New Invoice()
        'Dim rdReport As New ReportDocument
        'rdReport.Load(invoic.FullResourceName)
        ...
        rdReport.SetParameterValue(9, register.manageClass.subject.Subject)
        rdReport.SetParameterValue(8, register.manageClass.subject.basePrice)
